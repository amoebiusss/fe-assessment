...
import { StarlinkInfo, PaginatedLaunchInfo, PaginatedStarlinkInfo, LaunchItem, CrewMember, PaginatedCrewMembers } from '../../../../shared/interfaces';
...
export class DataService {
  ...
  getAllCrewMembers(): Observable<CrewMember[]> {
    return this.api.post<PaginatedCrewMembers>(`${this.baseUrl}/${this.crewUrl}/query`, JSON.stringify(allCrewMemberQuery)).pipe(map(res => res.docs));
  }
